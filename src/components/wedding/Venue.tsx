      ...
      <div className="relative z-10">
        ...
        >
          <div className="relative min-h-[380px] overflow-hidden">
            <img src={venue} alt="Crystal Convention Centre" className="h-full w-full object-cover" loading="lazy" />
            <motion.div
              animate={{ y: [0, -8, 0] }}
          ...
          <div className="glass flex flex-col justify-center gap-6 p-10 md:p-14">
            ...
            <p className="text-deep-brown/75 leading-relaxed">
              SF No 108/2 and 108/3, Madurai Road, Kallikudi Village, South, Manikandam, Trichy – 620012. Ample
              parking, blessings at the entrance, and warm South Indian hospitality.
            </p>
