    ...
    <section className="relative py-32 px-6">
      ...
      >
        <div className="relative min-h-[380px] overflow-hidden">
          <img src={venue} alt="Grand Empire Convention Hall" className="h-full w-full object-cover" loading="lazy" />
          <motion.div
            animate={{ y: [0, -8, 0] }}
        ...
        <div className="glass flex flex-col justify-center gap-6 p-10 md:p-14">
          <p className="font-display text-[10px] tracking-[0.5em] text-rose-gold uppercase">Reception & Ceremony</p>
          <h3 className="font-serif text-4xl leading-tight text-deep-brown md:text-5xl">
            Grand Empire <span className="italic text-gradient-gold">Convention Hall</span>
          </h3>
          <p className="text-deep-brown/75 leading-relaxed">
            A regal space dressed in florals and light — Trichy, Tamil Nadu. Ample parking, blessings at the entrance,
            and warm South Indian hospitality.
          </p>
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <a
              href="https://www.google.com/maps/search/?api=1&query=Grand+Empire+Convention+Hall+Trichy"
              target="_blank"
              rel="noreferrer"
